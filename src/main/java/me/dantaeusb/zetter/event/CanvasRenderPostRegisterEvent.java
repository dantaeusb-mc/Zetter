 ...
 */
public class CanvasRenderPostRegisterEvent extends Event {
    public final String canvasCode;
    public final AbstractCanvasData canvasData;
    public final long timestamp;

    public CanvasRenderPostRegisterEvent(String canvasCode, AbstractCanvasData canvasData, long timestamp) {
