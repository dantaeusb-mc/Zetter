...
public abstract class AbstractCanvasData extends SavedData {
  ...
  /**
   * Color data is stored as RGBA, 4 bytes per pixel
   * in linear RGB space. It is consistent with
   * NativeImage using GL_RGBA format, and will be
   * converted to sRGB at final rendering stage (I think).
   * <p>
   * However! When exporting, this should be converted
   * to sRGB space.
   */
