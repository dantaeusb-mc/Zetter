...
public class PaletteItem extends Item {
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(Level level, Player player, @NotNull InteractionHand hand) {
        ...
        for (Entity canvasHolder : canvasHolders) {
            ...
            // The score is a combination of angle and distance.
            // A smaller score is better. This prioritizes entities that are
            // both close to the center of vision and close to the player.
            double score = angle * distance;
