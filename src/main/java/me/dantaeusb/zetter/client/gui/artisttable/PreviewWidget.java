...
public class PreviewWidget extends AbstractArtistTableWidget implements Widget, GuiEventListener {
    private static final Component EMPTY_TITLE = new TranslatableComponent("container.zetter.artist_table.combined_canvas.empty");
    private static final Component INVALID_TITLE = new TranslatableComponent("container.zetter.artist_table.combined_canvas.invalid");
    private static final Component LOADING_TITLE = new TranslatableComponent("container.zetter.artist_table.combined_canvas.loading");
