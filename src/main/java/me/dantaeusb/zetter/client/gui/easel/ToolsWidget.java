...
public class ToolsWidget extends AbstractPaintingWidget implements Renderable {
    ...
    public void renderWidget(@NotNull PoseStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        blit(matrixStack, this.getX(), this.getY(), TOOL_BUTTONS_U - TOOL_BUTTON_WIDTH - 3, TOOL_BUTTONS_V - 1, TOOL_BUTTON_WIDTH + 2, TOOL_BUTTON_HEIGHT * this.buttons.size() + 2);
        ...
        for (ToolButton toolButton: this.buttons) {
            ...
            blit(matrixStack, this.getX() + 1, fromY, uOffset, toolButton.vPosition, toolButton.width, toolButton.height);
            i++;
        }
    }
