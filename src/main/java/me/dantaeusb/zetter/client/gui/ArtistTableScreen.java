...
public class ArtistTableScreen extends AbstractContainerScreen<ArtistTableMenu> implements ContainerListener {
    public static final Component TITLE = new TranslatableComponent("container.zetter.artist_table");

    private static final Component SPLIT_MODE_TITLE = new TranslatableComponent("container.zetter.artist_table.mode.split");
    private static final Component COMBINE_MODE_TITLE = new TranslatableComponent("container.zetter.artist_table.mode.combine");
    ...
    protected void renderLabels(PoseStack matrixStack, int mouseX, int mouseY) {
        ...
        Component artistTableLabel = new TranslatableComponent("container.zetter.artist_table.mode", this.titleLabel, artistTableModelLabel);
