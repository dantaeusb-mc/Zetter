...
public class ArtistTableScreen extends AbstractContainerScreen<ArtistTableMenu> implements ContainerListener {
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        guiGraphics.drawString(this.font, artistTableLabel, LABEL_XPOS, LABEL_YPOS, Color.DARK_GRAY.getARGB(), false);
        ...
        guiGraphics.drawString(this.font, this.playerInventoryTitle, PLAYER_INV_LABEL_XPOS, PLAYER_INV_LABEL_YPOS, Color.DARK_GRAY.getARGB(), false);
    }
