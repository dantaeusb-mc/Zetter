...
public class TabsWidget extends AbstractPaintingWidget implements IRenderable {
    ...
    public TabsWidget(EaselScreen parentScreen, int x, int y) {
        super(parentScreen, x, y, WIDTH, HEIGHT, new TranslationTextComponent("container.zetter.painting.tabs"));
    ...
    public enum Tab {
        COLOR("color", new TranslationTextComponent("container.zetter.painting.tabs.color")),
        PENCIL_PARAMETERS("pencil_parameters", new TranslationTextComponent("container.zetter.painting.tabs.pencil_parameters")),
        BRUSH_PARAMETERS("brush_parameters", new TranslationTextComponent("container.zetter.painting.tabs.brush_parameters")),
        BUCKET_PARAMETERS("bucket_parameters", new TranslationTextComponent("container.zetter.painting.tabs.bucket_parameters")),
        INVENTORY("inventory", new TranslationTextComponent("container.zetter.painting.tabs.inventory"));
        ...
        Tab(String code, ITextComponent translatableComponent) {
            this.code = code;
