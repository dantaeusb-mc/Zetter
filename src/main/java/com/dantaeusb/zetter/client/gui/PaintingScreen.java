...
public class PaintingScreen extends ContainerScreen<EaselContainer> {
    ...
    protected void handlePaletteClick(final int mouseX, final int mouseY) {
        ...
        if (slotIndex == -1) {
            Zetter.LOG.warn("Cannot find palete slot!");
            return;
        }
