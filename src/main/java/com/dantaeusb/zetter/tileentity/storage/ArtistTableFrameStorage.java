...
public class ArtistTableFrameStorage implements IInventory {
     ...
     */
    public static ArtistTableFrameStorage createForTileEntity(Predicate<PlayerEntity> canPlayerAccessInventoryLambda,
                                                              Notify markDirtyNotificationLambda) {
        return new ArtistTableFrameStorage(canPlayerAccessInventoryLambda, markDirtyNotificationLambda);
    }

    public static ArtistTableFrameStorage createForClientSideContainer() {
        return new ArtistTableFrameStorage();
    }

    private ArtistTableFrameStorage() {
        this.stackHandler = new ItemStackHandler(STORAGE_SIZE) {

        };
    }

    private ArtistTableFrameStorage(Predicate<PlayerEntity> canPlayerAccessInventoryLambda, Notify markDirtyNotificationLambda) {
        this();
